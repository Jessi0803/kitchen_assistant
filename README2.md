...
╠═══════════════════════════════════════════════════════════════════════════╣
║                                                                           ║
║  📱 Take Photo  →  👁️ Detect Ingredients  →  🍳 Generate Recipe          ║
║                                                                           ║
║  Settings:  ☐ Use Local Processing    ☐ Use MLX Generation              ║
║                                                                           ║
╚═══════════════════════════════════════════════════════════════════════════╝
                                    │
                    ┌───────────────┼───────────────┐
...
┌─────────────────┐   ┌─────────────────┐   ┌─────────────────┐
│   ☁️ CLOUD      │   │  📱 ON-DEVICE   │   │  📱 ON-DEVICE   │
├─────────────────┤   ├─────────────────┤   ├─────────────────┤
│ AWS EC2         │   │ CoreML YOLO     │   │ CoreML YOLO     │
│ FastAPI Backend │   │ Neural Engine   │   │ Neural Engine   │
│                 │   │                 │   │                 │
│ YOLOv8n         │   │ yolov8n.mlmodel │   │ yolov8n.mlmodel │
│ (PyTorch)       │   │ (~6MB)          │   │ (~6MB)          │
│                 │   │                 │   │                 │
│ 🌐 Needs WiFi   │   │ ✅ Offline      │   │ ✅ Offline      │
│ ⏱️ 500ms-1s     │   │ ⚡ ~100ms       │   │ ⚡ ~100ms       │
└────────┬────────┘   └────────┬────────┘   └────────┬────────┘
         │                     │                     │
         └─────────────────────┴─────────────────────┘
                               │
...
│ (4-bit quant)   │   │ (4-bit quant)   │   │ (Full model)    │
│                 │   │                 │   │                 │
│ 💾 ~300MB       │   │ 💾 ~300MB       │   │ 💾 ~2GB         │
│ 🧠 500M params  │   │ 🧠 500M params  │   │ 🧠 3B params    │
│                 │   │                 │   │                 │
│ 📱 iPhone GPU   │   │ 📱 iPhone GPU   │   │ 🖥️ Mac GPU      │
│ ⏱️ 10-30s       │   │ ⏱️ 10-30s       │   │ ⚡ 5-10s        │
│                 │   │                 │   │                 │
│ ⭐ Good         │   │ ⭐ Good         │   │ ⭐⭐⭐ Excellent │
│ ✅ Offline      │   │ ✅ Offline      │   │ 🌐 Local WiFi   │
└────────┬────────┘   └────────┬────────┘   └────────┬────────┘
         │                     │                     │
         └─────────────────────┴─────────────────────┘
                               │
                  📖 Generated Recipe (JSON)
           {title, ingredients, steps, nutrition...}
                               │
